...
class DataSource:
    ...
    def __init__(self, data_source_config):
        ...
        assert self.config["functions"] is not None, "functions must be defined in data_source_config"
        assert len(self.config["functions"]) == 1, "Only one get_data function is supported"
