...
def bayes_opt_main_pipeline(cfg: DictConfig):
    ...
    for session in sessions_info:
        ...
        # Bayesian Optimizer (update Bayesian Optimizer with evaluate function)
        # Call reinit to reformat the Bayesian Optimizer for the next session.
        # bayes_opt = init_bayes_opt(global_config["BAYES_OPT_CONFIG"], evaluate, reporter, experiment_tracker)
